...
def test_parse_from_url_mpd_tag():
    """ Test that parser works and create MPD object from URL target """
    class QuietHandler(SimpleHTTPRequestHandler):
        def log_message(self, format, *args):
            pass

    Handler = lambda *args, **kwargs: QuietHandler(*args, directory="./../", **kwargs)
    ...
    try:
        url = f"http://127.0.0.1:{port}/manifests/bigBuckBunny-onDemend.mpd"
